...
function SwapPage() {
  ...
  return (
    <Flex direction="column" spaceY={4} mt={8}>
      ...
      <SwapToken signer={signer} tokenAContract={tokenAContract} tokenBContract={tokenBContract} liquidityPoolContract={liquidityPoolContract} toggleCurrent={toggleCurrent} setToggleCurrent={setToggleCurrent} />
    </Flex>
  );
}
